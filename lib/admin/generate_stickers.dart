...
class _GenerateStickersPageState extends State<GenerateStickersPage> {
  ...
  void generateBarcodes() {
    ...
    for (int i = 1; i <= qty; i++) {
      barcodes.add("${selectedAnimal.toUpperCase()}-${i.toString().padLeft(3, '0')}");
    }
    setState(() {
          ...
          build: (context) {
            return pw.Center(
              child: pw.Column(
                ...
                children: [
                  pw.Text(barcodeId, style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text(barcodeId, style: const TextStyle(fontWeight: FontWeight.bold)),
